  ...
  return (
    <>
      ...
      <div className="fixed inset-0 w-full h-full pointer-events-none z-[-1] overflow-hidden">
        ...
        <div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-[#C5A880]/15 blur-[140px] mix-blend-screen opacity-70 animate-pulse" style={{ animationDuration: '8s' }}></div>
        
        {/* 2. Deep Midnight Blue Ambient Glow (Bottom Right) */}
        <div className="absolute bottom-[-20%] right-[-10%] w-[70vw] h-[70vw] rounded-full bg-[#1A2840]/40 blur-[150px] mix-blend-screen opacity-80 animate-pulse" style={{ animationDuration: '12s' }}></div>

        {/* 3. Subtle Center Accent */}
        <div className="absolute top-[40%] left-[30%] w-[40vw] h-[40vw] rounded-full bg-[#C5A880]/5 blur-[120px] mix-blend-screen opacity-50"></div>
      </div>
      ...
      <div className="fixed inset-0 w-full h-full pointer-events-none z-[100] overflow-hidden">
        ...
        {/* 4. Fine Film Grain Texture (Using highly optimized SVG Noise) */}
        <div 

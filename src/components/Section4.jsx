...
export default function Section4() {
  ...
  return (
    <section ref={containerRef} className="min-h-screen w-full bg-[#F9F9F7] text-[#050505] relative flex flex-col justify-center py-32 px-8 md:px-24 border-t border-[#050505]/10 cursor-none overflow-hidden">
      
      <div className="flex flex-col md:flex-row w-full justify-between items-start mb-24 relative z-10 pointer-events-none">
        <h2 className="text-4xl md:text-7xl font-serif">Our <span className="italic text-[#D4AF37]">Services</span></h2>
      ...
      <div className="flex flex-col w-full relative z-10">
        {services.map((s, idx) => (
          <div 
            ...
            className="border-b border-[#050505]/20 py-8 md:py-16 group relative"
          >
            <div className="absolute inset-0 bg-[#050505] scale-y-0 origin-bottom transition-transform duration-700 ease-[cubic-bezier(0.7,0,0.3,1)] group-hover:scale-y-100 z-0"></div>
            
            <div className="flex flex-col md:flex-row gap-4 md:gap-16 items-start md:items-baseline pointer-events-none relative z-10">
              <span className="text-sm font-mono opacity-40 group-hover:opacity-100 group-hover:text-[#D4AF37] transition-colors duration-500">{s.num}</span>
